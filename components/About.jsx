        ...
        <div id="about" className="w-full md:h-screen p-2 flex items-center py-16">
            <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
                <div className="col-span-2">
                    <p className="uppercase text-xl tracking-widest text-[#1b6dc1]">About</p>
                    <h2 className="py-4">Who I Am</h2>
                    <p className="py-2 text-gray-600">I'm your special web developer</p>
                    <p className="py-2 text-gray-600">I've spent around 10 years working as a sound engineer, then I
                        came back home where I graduated a
                    ...
                    <p className="py-2 text-gray-600">I was since my young age really into computers, hardware &
                        software. As soon as I started
                    ...
                    <Link href='/#projects'>
                        <p className="py-2 text-gray-600 underline cursor-pointer">Below are some of my latest projects and
                            applications I worked on.</p>
                    </Link>
                </div>
                <div
