        ...
        <div className="w-full md:h-screen p-2 flex items-center py-16">
            <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
                <div className="col-span-2">
                    <p>About</p>
                    <h2>Who I Am</h2>
                    <p>I'm your special web developer</p>
                    <p>I've spent around 10 years working as a sound engineer, then I came back home where I graduated a
                    ...
                    <p>I was since my young age really into computers, hardware & software. As soon as I started
                    ...
                    <p>Below are some of my latest projects and applications I worked on.</p>
                </div>
                <div>
                    <img
