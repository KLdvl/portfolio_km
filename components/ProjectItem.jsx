    ...
    return (
        <div
            ...
            <div
                ...
                <p className="pb-4 pt-2 text-white text-center">{mainTechnos}</p>
                <Link href={projectUrl}>
                    <p className="text-center py-3 rounded-lg bg-white text-gray-700 font-bold text-lg cursor-pointer">More
                        Info</p>
                </Link>
            </div>
        </div>
