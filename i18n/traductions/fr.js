const fr = {
	translation: {
		...
		project_evolution_web_title: "Chronologie interactive de l'histoire du développement web",
		project_evolution_web_description:
			"Embarquez pour un voyage captivant à travers les âges numériques avec notre projet novateur : une infographie interactive qui retrace l'Évolution du Web. Des premiers jours des pages web statiques au royaume virtuel dynamique et interconnecté que nous explorons aujourd'hui, ce projet offre une exploration visuellement époustouflante de la transformation du web au fil du temps. Plongez dans les jalons importants qui ont façonné le paysage en ligne, découvrant comment les avancées technologiques, les comportements des utilisateurs et l'ingéniosité créative se sont combinés pour façonner le web tel que nous le connaissons.",
		// Skills component
