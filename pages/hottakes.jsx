        ...
        <div className="w-full">
            <div className="w-screen h-[30vh] lg:h-[40vh] relative">
                ...
                <div
                    ...
                    <h2 className="py-2">Sauce sharing app</h2>
            ...
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
                <div className="col-span-4">
                    <p>Project</p>
                    <h2>Overview</h2>
                    <p>This app was build using node JS to create a fully operationnal CRUD api. The app is secured, it
                        respects the standards of OWASP. You can sign up usign email and password and use them as well
                        for log in. Every data stored in the database is secure. Every user can create, update and
                        delete sauces. It's possible to like / dislike sauces too only one like / dislike is allowed per
                        user per sauce. </p>
